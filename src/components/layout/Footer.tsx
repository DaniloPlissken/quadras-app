...
export function Footer() {
  return (
    <footer className="w-full bg-primary text-white pt-12 pb-6 mt-auto">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        
        {/* Logo and Info */}
        <div className="flex flex-col gap-4">
          <div className="flex flex-col">
            <span className="font-bold text-xl leading-tight text-accent">PREFEITURA DE</span>
        ...
        {/* Links Rápidos */}
        <div className="flex flex-col gap-4">
          <h3 className="font-bold text-lg text-accent mb-2">Links Rápidos</h3>
        ...
        {/* Contato */}
        <div className="flex flex-col gap-4">
          <h3 className="font-bold text-lg text-accent mb-2">Contato</h3>
          <ul className="flex flex-col gap-2 text-sm text-gray-200">
